...
export function HexButton({borderColor, clicked, fontSize, onClick, size, text}: HexButtonProps) {
    ...
    return (
        ...
        >
            ...
            >
                ...
                <polygon
                    points={hexagonPoints}
                    fill={clicked ? borderColorr : (hovered ? alpha(borderColorr, 0.1) : "transparent")}
